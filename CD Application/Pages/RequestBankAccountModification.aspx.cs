...
public partial class Pages_RequestBankAccountModification : System.Web.UI.Page
{
    ...
    List<Guid> FinilizedMembersList
    {
        get
        {
            if (Session["MembersListWithModificationRequested"] == null)
            {
                return new List<Guid>();
            }
            else
            {
                return (List<Guid>)Session["MembersListWithModificationRequested"];
            }
        }
        set
        {
            Session["MembersListWithModificationRequested"] = value;
        }
    }
