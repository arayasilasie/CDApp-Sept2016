<%@ Page Language="C#" MasterPageFile="~/MasterPages/pTop.master" AutoEventWireup="true" 
    CodeFile="Unsold_ExpiredWHR.aspx.cs" Inherits="ECX.CD.UI.Pages_Unsold_ExpiredWHR" Title="Unsold/Expired WarehouceRecipts"%>
 ...
 <fieldset>
     ...
     <HeaderTemplate>
             <table cellpadding="3px" cellspacing="0" id="MyTable" width="100%">
                <thead>
                    <tr>
                       <td><input runat="server" type="checkbox" id="chkSelectAll" style="width:15px;" onclick="SelectAllRows(this)" /></td>
                       <td>WHR ID</td>
                       <td>Client ID</td>
                       <td>Name</td>
                       <td>GRN No.</td>
           ...
           <ItemTemplate>
            <tbody>
                <tr class="GridviewRow">
                    ...
                    <td><asp:HiddenField ID="lblWRStatusId" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "WRStatusId")%>' /> <asp:label runat="server" ID="lblStat" Text='<%# DataBinder.Eval(Container.DataItem, "WRStatusName")%>'></asp:label> </td>
