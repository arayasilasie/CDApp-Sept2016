<%@ Page Language="C#" MasterPageFile="~/MasterPages/pTop.master" 
    AutoEventWireup="true" CodeFile="ApproveWHR.aspx.cs" 
    Inherits="ECX.CD.UI.Pages_ApproveWHR" Title="Warehouse Receipt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <link href="../Styles/ControlsViewFormStyle.css" rel="stylesheet" type="text/css" />
    ...
    <div id="form_1">
          ...
          <div class="controlContainer">    
            <div class="leftControl">   
              <asp:Label ID="Label5" runat="server" Text="Consignment Type"></asp:Label>
            </div>        
            <div class="rightControl">
            <asp:DropDownList ID="ddlConsType" runat="server">
                <asp:ListItem Selected="True" Value="0">Select Consignment Type</asp:ListItem>
                <asp:ListItem Value="1">Bonded Yard</asp:ListItem>
                <asp:ListItem Value="2">Truck to Warehouse</asp:ListItem>
                <asp:ListItem Value="3">Direct to Warehouse</asp:ListItem>
            </asp:DropDownList> <br />           
            <asp:Button ID="Button1" Text="Find" runat="server" onclick="btnFind_Click" BorderStyle="None" />    
            </div>        
          </div> 
   <br /><br />       
        ...
        <HeaderTemplate>
          ...
          <ItemTemplate>
            <tr class="GridviewRow">
                ...
                <td> <%# Convert.ToInt32(DataBinder.Eval(Container.DataItem, "ConsignmentType"))==1 ? "BY" : Convert.ToInt32(DataBinder.Eval(Container.DataItem, "ConsignmentType"))==2 ? "TW" : "DW" %> </td>
