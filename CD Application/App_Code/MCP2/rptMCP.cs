...
{
    /// <summary>
    /// Summary description for rptMCP.
    /// </summary>
    /// 
    public class rptMCP : DataDynamics.ActiveReports.ActiveReport
    {
        ...
        private SubReport subMemberAccounts;
        private Line line4;
        private Line line5;
        private Line line7;
        ...
        private GroupHeader ghProductionYear;
        private GroupFooter gfProductionYear;
        private TextBox txtSubTotal;
        private SubReport subClientAccounts;
        ...
        private DataTable bankBalanceTable;
        private DataTable whrTable;

        //newly added code
        private List<Datalayer.MCP_WHR> lstMCP_WHR;
        //end of newly added code

        private subClientAccounts _clientSubReport;
        private subMemberAccounts _memberSubReport;
        ...
        public rptMCP()
        {
            ...
            //
            InitializeComponent();
            Datalayer.MCPService mcpService = new Datalayer.MCPService();
            whrTable = mcpService.WHR;
            bankBalanceTable = mcpService.BankBalance;
        }
        public rptMCP(DataTable whTable, DataTable bankTable)
        {
            //
            // Required for Windows Form Designer support
            //
            ...
            whrTable = whTable;
            bankBalanceTable = bankTable;
            this.DataSource = whrTable;

        }

        //newly added code
        public rptMCP(List<Datalayer.MCP_WHR> mcp_WHR, DataTable bankTable)
        {
            //
            // Required for Windows Form Designer support
            //
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.rptMCP));
            ...
            this.subMemberAccounts = new DataDynamics.ActiveReports.SubReport();
            ...
            this.ghProductionYear = new DataDynamics.ActiveReports.GroupHeader();
            this.gfProductionYear = new DataDynamics.ActiveReports.GroupFooter();
            this.txtSubTotal = new DataDynamics.ActiveReports.TextBox();
            this.lblSubTotal = new DataDynamics.ActiveReports.Label();
            this.subClientAccounts = new DataDynamics.ActiveReports.SubReport();
            ...
            this.txtCurrentQuantity.Left = 6.375999F;
            ...
            this.txtCurrentQuantity.Style = "font-weight: normal; text-align: right; white-space: nowrap";
            this.txtCurrentQuantity.Text = "1,000.0000";
            this.txtCurrentQuantity.Top = 0.062F;
            this.txtCurrentQuantity.Width = 0.8279999F;
            // 
            // txtDaysRemaining
            // 
            ...
            this.txtWarehouse.Width = 1.135F;
            // 
            // txtWHRId
            // 
            ...
            // textBox1
            // 
            this.textBox1.DataField = "ConsignmentType";
            ...
            this.lblOrg.Style = "font-family: Verdana; font-size: 14.25pt; font-weight: bold; text-align: left; dd" +
                "o-char-set: 0";
            this.lblOrg.Text = "MCP";
            this.lblOrg.Top = 0.25F;
            this.lblOrg.Width = 5.7605F;
            // 
            // imgLogo
            // 
            ...
            this.infoGeneratedDate.Left = 9.5625F;
            ...
            this.groupHeader1.Height = 0.59F;
            ...
            // subMemberAccounts
            // 
            this.subMemberAccounts.CloseBorder = false;
            this.subMemberAccounts.Height = 0.104F;
            this.subMemberAccounts.Left = 0.08000001F;
            this.subMemberAccounts.Name = "subMemberAccounts";
            this.subMemberAccounts.Report = null;
            this.subMemberAccounts.ReportName = "";
            this.subMemberAccounts.Top = 0.486F;
            this.subMemberAccounts.Width = 10.357F;
            // 
            // line4
            // 
            ...
            this.txtMemberGuid.Height = 0.1979167F;
            this.txtMemberGuid.Left = 9.323001F;
            this.txtMemberGuid.Name = "txtMemberGuid";
            this.txtMemberGuid.Text = "Member Guid";
            this.txtMemberGuid.Top = 0.125F;
            ...
            this.line10.Left = 0F;
            this.line10.LineColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(165)))), ((int)(((byte)(0)))));
            this.line10.LineWeight = 3F;
            this.line10.Name = "line10";
            this.line10.Top = 0.425F;
            this.line10.Width = 10.5F;
            this.line10.X1 = 0F;
            this.line10.X2 = 10.5F;
            this.line10.Y1 = 0.425F;
            this.line10.Y2 = 0.425F;
            // 
            // groupFooter1
            // 
            ...
            this.label15.Text = "Consignment Type";
            this.label15.Top = 0F;
            this.label15.Width = 0.7800006F;
            // 
            // label16
            // 
            ...
            this.ghClient.Height = 0.01041667F;
            this.ghClient.Name = "ghClient";
            this.ghClient.Format += new System.EventHandler(this.ghClient_Format);
            // 
            // gfClient
            // 
            ...
            // gfWarehouse
            // 
            this.gfWarehouse.Height = 0F;
            this.gfWarehouse.KeepTogether = true;
            this.gfWarehouse.Name = "gfWarehouse";
            this.gfWarehouse.Visible = false;
            this.gfWarehouse.Format += new System.EventHandler(this.gfWarehouse_Format);
            // 
            // ghProductionYear
            // 
            this.ghProductionYear.DataField = "ProductionYear";
            this.ghProductionYear.GroupKeepTogether = DataDynamics.ActiveReports.GroupKeepTogether.All;
            this.ghProductionYear.Height = 0F;
            this.ghProductionYear.Name = "ghProductionYear";
            // 
            // gfProductionYear
            // 
            this.gfProductionYear.Controls.AddRange(new DataDynamics.ActiveReports.ARControl[] {
            this.txtSubTotal,
            this.lblSubTotal});
            this.gfProductionYear.Height = 0.2F;
            this.gfProductionYear.KeepTogether = true;
            this.gfProductionYear.Name = "gfProductionYear";
            // 
            // txtSubTotal
            // 
            this.txtSubTotal.DataField = "Quantity";
            this.txtSubTotal.Height = 0.1875F;
            this.txtSubTotal.Left = 6.063001F;
            ...
            this.txtSubTotal.SummaryGroup = "ghProductionYear";
            ...
            // subClientAccounts
            // 
            this.subClientAccounts.CloseBorder = false;
            this.subClientAccounts.Height = 0.104F;
            this.subClientAccounts.Left = 0.08000001F;
            this.subClientAccounts.Name = "subClientAccounts";
            this.subClientAccounts.Report = null;
            this.subClientAccounts.ReportName = "";
            this.subClientAccounts.Top = 0F;
            this.subClientAccounts.Width = 10.357F;
            // 
            // groupHeader3
            // 
            this.groupHeader3.Controls.AddRange(new DataDynamics.ActiveReports.ARControl[] {
            this.subClientAccounts,
            this.line9,
            this.line11});
            this.groupHeader3.Height = 0.1248333F;
            this.groupHeader3.Name = "groupHeader3";
            this.groupHeader3.RepeatStyle = DataDynamics.ActiveReports.RepeatStyle.All;
            // 
            // line9
            // 
            this.line9.AnchorBottom = true;
            this.line9.Height = 0.104F;
            this.line9.Left = 0F;
            this.line9.LineColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(165)))), ((int)(((byte)(0)))));
            ...
            this.line9.X2 = 0F;
            this.line9.Y1 = 0F;
            this.line9.Y2 = 0.104F;
            // 
            // line11
            // 
            this.line11.AnchorBottom = true;
            this.line11.Height = 0.104F;
            this.line11.Left = 10.5F;
            this.line11.LineColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(165)))), ((int)(((byte)(0)))));
            this.line11.LineWeight = 3F;
            this.line11.Name = "line11";
            this.line11.Top = 0F;
            this.line11.Width = 0F;
            this.line11.X1 = 10.5F;
            this.line11.X2 = 10.5F;
            this.line11.Y1 = 0F;
            this.line11.Y2 = 0.104F;
            // 
            // groupFooter3
            // 
            ...
            this.Sections.Add(this.ghProductionYear);
            this.Sections.Add(this.detail);
            this.Sections.Add(this.gfProductionYear);
            ...
            this.ReportStart += new System.EventHandler(this.rptMCP_ReportStart);
            this.DataInitialize += new System.EventHandler(this.rptMCP_DataInitialize);
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //    chkIsMember.Visible = true;
                //}
                barcode1.Text = txtMemberID.Text + "_" + DateTime.Now.ToString();
            }
            catch (Exception ex)
            {
        ...
        {
            this.subClientAccounts.Report = new subClientAccounts();
            this.subClientAccounts.Report.DataSource = bankBalanceTable.Select("(ClientID IS NOT NULL)  AND MemberGuid = '" + txtMemberGuid.Text + "'");
            this.subMemberAccounts.Report = new subMemberAccounts();
            this.subMemberAccounts.Report.DataSource = bankBalanceTable.Select("(ClientID IS NULL)  AND MemberGuid = '" + txtMemberGuid.Text + "'");
        }
        ...
        private void gfWarehouse_Format(object sender, EventArgs e)
        {
            try
            {
                if (float.Parse(txtSubTotal.Text) == 0)
                {
        ...
        private void ghClient_Format(object sender, EventArgs e)
        {

        }

        private void rptMCP_DataInitialize(object sender, EventArgs e)
        {

        }

        private void rptMCP_ReportStart(object sender, EventArgs e)
        {
