...
/// <summary>
/// Summary description for MemberClientPosition.
/// </summary>
public partial class MemberClientPosition : DataDynamics.ActiveReports.ActiveReport
{
    public static MCPCollection mcp;

    #region Report Control Declaration
    ...
    #endregion Report Control Declaration

    static MemberClientPosition()
    {
    }
    public MemberClientPosition()
    {
        //
    ...
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.MemberClientPosition));
        ...
        this.txtClientId.Top = 0.06199999F;
        ...
        this.txtExpiryDate.Left = 7.256001F;
        ...
        this.txtExpiryDate.Width = 0.8559999F;
        // 
        // txtWarehouse
        // 
        ...
        this.line4.Left = 0F;
        this.line4.LineColor = System.Drawing.Color.Orange;
        ...
        this.txtMemberGuid.Height = 0.1875F;
        this.txtMemberGuid.Left = 6.313F;
        this.txtMemberGuid.Name = "txtMemberGuid";
        this.txtMemberGuid.Text = null;
        this.txtMemberGuid.Top = 0.188F;
        this.txtMemberGuid.Visible = false;
        this.txtMemberGuid.Width = 0.5929995F;
        // 
        // groupFooter1
        // 
        ...
        this.groupHeader2.Controls.AddRange(new DataDynamics.ActiveReports.ARControl[] {
            ...
            this.label15,
            this.label16});
        this.groupHeader2.Height = 0.3688334F;
        ...
        this.label7.Top = 0.09550002F;
        this.label7.Width = 0.6379999F;
        // 
        // label8
        // 
        ...
        this.gfWarehouse.Format += new System.EventHandler(this.gpfSummary_Format);
        // 
        // txtSubTotal
        // 
        this.txtSubTotal.DataField = "Quantity";
        this.txtSubTotal.Height = 0.1875F;
        this.txtSubTotal.Left = 6.063F;
        ...
        this.lblSubTotal.Width = 0.7399998F;
        // 
        // ghSymbol
        // 
        ...
        this.ReportStart += new System.EventHandler(this.MemberClientPosition_ReportStart);
    ...
    {
        subPayInAccountStatus.Report = new PayInAccountStatus();
        subPayInAccountStatus.Report.UserData = txtMemberGuid.Text;
    }

    private void MemberClientPosition_ReportStart(object sender, EventArgs e)
    {
        //if (mcp.Count == 0)
        //{
        //    mcp.AddEmptyRow(Guid.Empty, string.Empty, string.Empty);
        //}
        //this.DataSource = mcp;
    }

    private void gpfSummary_Format(object sender, EventArgs e)
    {
        try
        {
