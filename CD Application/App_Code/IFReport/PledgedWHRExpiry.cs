...
/// <summary>
/// Summary description for PledgedWHRExpiry.
/// </summary>
public class PledgedWHRExpiry : DataDynamics.ActiveReports.ActiveReport
{
    ...
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Resources.PledgedWHRExpiry));
        ...
        this.txtValue.Width = 0.7609995F;
        // 
        // txtPledgeRequestId1
        // 
        ...
        this.lblOrg.Style = "ddo-char-set: 0; text-align: left; font-weight: bold; font-size: 14.25pt; font-fa" +
            "mily: Verdana";
        this.lblOrg.Text = "Pledged WHR Expiry";
