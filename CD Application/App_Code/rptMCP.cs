...
public class rptMCP : DataDynamics.ActiveReports.ActiveReport
{
	...
	private void InitializeComponent()
	{
        ...
        this.label15.Text = "Consignment";
        this.label15.Top = 0F;
        this.label15.Width = 0.623001F;
        // 
        // label16
        // 
        ...
        this.groupHeader3.Controls.AddRange(new DataDynamics.ActiveReports.ARControl[] {
            ...
            this.line9,
            this.line11});
        this.groupHeader3.Height = 0.0935833F;
    ...
    private void groupHeader1_Format(object sender, EventArgs e)
    {
        ...
        subMemberAccounts.Report = new subMemberAccounts();
        subClientAccounts.Report = new subClientAccounts();

        if (Common.IsGuid(txtMemberGuid.Text))
        {

            DataTable bankAccounts = ECX.CD.BL.BankAccount.GetBankAccountsView(new Guid(txtMemberGuid.Text));

            subMemberAccounts.Report.DataSource = bankAccounts.Select("ClientID IS NULL"); ;
            subClientAccounts.Report.DataSource = bankAccounts.Select("ClientID IS NOT NULL"); ;
